console.log("ComfyUI-Trajectory/web/page/main.js  - executing");
...
function transmitTrajectory(trajectory,title="",selected=true) {
    if (portToMain) {
        portToMain.postMessage( {"trajectory": trajectory,title,selected} );
      }
  }
