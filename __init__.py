...
#            },
    ...
    def image_buffer(self, unique_id, mask, canvas, trajectory, images=None):
...
#        print(f"Node {unique_id}: images: {images}")    
        ...
        return (rgb_image, mask_data, trajectory) 
...
NODE_DISPLAY_NAME_MAPPINGS = {
    "Trajectory_Canvas_Tab": "Edit Trajectory In Another Tab",
}
